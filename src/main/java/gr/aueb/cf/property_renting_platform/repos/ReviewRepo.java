...
import gr.aueb.cf.property_renting_platform.DTOs.responses.review.ReviewDTO;
import gr.aueb.cf.property_renting_platform.DTOs.responses.review.ReviewSummaryDTO;
import gr.aueb.cf.property_renting_platform.models.review.Review;
...
public interface ReviewRepo extends JpaRepository<@NonNull Review, @NonNull Long> {
    ...
    @Query("""
    select new gr.aueb.cf.property_renting_platform.DTOs.responses.review.ReviewSummaryDTO(
    ...
    @Query(
            value = """
      select new gr.aueb.cf.property_renting_platform.DTOs.responses.review.ReviewDTO(
          r.uuid, r.rating, r.positiveComment, r.negativeComment,
          r.ownerResponse, r.createdAt, r.ownerRespondedAt,
          new gr.aueb.cf.property_renting_platform.DTOs.responses.user.UserDTO(
            g.uuid,
            g.email,
            g.role.id,
